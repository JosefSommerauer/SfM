...
private:
  ...
  double mFindFOutlierDistance = 1.0;
...
public:
  ...
  void setRansacParameter(int method, double param_1 = 3.0, double param_2 = 0.99);

  virtual bool estimatePose(Camera const &cam, ViewCombination &view,
  ...
  void removeOutlier(Camera const & cam, ViewCombination &view);
};
